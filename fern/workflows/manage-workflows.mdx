...
<CardGroup cols={2}>
  ...
  >
    Complete reference for all block types, parameters, and YAML examples
  </Card>
  <Card
    title="Run Workflows"
    icon="play"
  ...
  >
    Trigger runs via the API and pass runtime parameters
  </Card>
  <Card
  ...
  >
    Declare and pass parameters between blocks
  </Card>
  <Card
    title="Consistency and Reliability"
    icon="shield-check"
    href="/workflows/consistent-workflows"
  >
    Tips for building robust, production-ready workflows
  </Card>
</CardGroup>