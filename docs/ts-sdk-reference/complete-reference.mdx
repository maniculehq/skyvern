...
const result = await skyvern.runTask({
  body: {
    ...
    engine?: RunEngine,                              // "skyvern-2.0" (default), "skyvern-1.0", "openai-cua", "anthropic-cua", "ui-tars"
...
- `engine` accepts string values: `"skyvern-1.0"`, `"skyvern-2.0"`, `"openai-cua"`, `"anthropic-cua"`, `"ui-tars"`.
