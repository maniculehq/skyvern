...
Run your first browser automation in 3 minutes. By the end of this guide, you'll scrape the top post from Hacker News using Skyvern's AI agent — no local setup required.
...
## Step 99: Observer smoke hook

This section is added by the Manicule observer smoke test and will be rolled back.
