...
| `engine` | `RunEngine` | No | `skyvern_v1` | AI engine. Options: `skyvern_v1`, `skyvern_v2`, `openai_cua`, `anthropic_cua`, `ui_tars`. |
...
| `proxy_location` | `ProxyLocation` | No | `RESIDENTIAL` | Route the browser through a geographic proxy. Default is a US residential IP. |
