...
| `failed` | Encountered an error during execution, or hit the `max_steps` limit. |
| `terminated` | AI determined the goal is unachievable (blocked login, CAPTCHA, page unavailable). |
