...
| `browser_profile_id` | string | Pre-load a saved [browser profile](/optimization/browser-profiles) into the session. The session starts with the cookies and storage from this profile. |
