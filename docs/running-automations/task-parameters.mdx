...
Use this for two-factor authentication during task execution. See [Handle 2FA](/credentials/handle-2fa) for setup instructions.
...
Use this when Skyvern should pull codes from your endpoint rather than you pushing them. See [Handle 2FA](/credentials/handle-2fa) for setup instructions.
