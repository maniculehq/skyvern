...
By default, Skyvern returns extracted data in whatever format makes sense for the task. Pass a `data_extraction_schema` to enforce a specific structure using [JSON Schema](https://json-schema.org/).
