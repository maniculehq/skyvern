...
**Returns:** `str` (value filled into the field)
...
**Returns:** `str | None` (value successfully selected, or `None` if nothing was selected)
...
**Returns:** `str` (value typed into the field)
...
**Returns:** `str` (file path or URL that was uploaded)
...
**Returns:** `str` (value selected from the dropdown, or the typed value if no dropdown appeared)
