...
| `current_date` | All blocks | Today's date in ISO 8601 format |
...
| `workflow_run_outputs` | All blocks | Collected outputs from all blocks in the current run |
| `workflow_run_summary` | All blocks | Summary of the current workflow run |
