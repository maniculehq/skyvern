...
<Info>
Skyvern supports 24 block types: navigation, extraction, validation, file download, for loops, conditionals, workflow triggers, and more. See [Workflow Blocks Reference](/multi-step-automations/workflow-blocks-reference) for the full list.
</Info>
