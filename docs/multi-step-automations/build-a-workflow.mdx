...
<Info>
Skyvern supports 24 block types: navigation, extraction, validation, file download, for loops, conditionals, and more. See [Workflow Blocks Reference](/multi-step-automations/workflow-blocks-reference) for the full list.
</Info>
...
<CardGroup cols={2}>
  ...
  >
    Detailed documentation for all 24 block types
  </Card>
  <Card
  ...
  >
    Define input parameters, pass data between blocks, and use Jinja templates
  </Card>
  <Card
